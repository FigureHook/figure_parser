...
from figure_parser.core.usecase.sort_release import ReleaseSorting

from .utils import make_last_element_filler


class AbstractBaseProductParser(ProductParserInterface[BeautifulSoup], ABC):
    @abstractmethod
    ...
    def parse_releases(self, source: BeautifulSoup) -> List[Release]:
        ...
        return ReleaseSorting.sort(releases)
